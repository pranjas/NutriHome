 ...
 */
public class CreateMethod extends CommonMethod<Profile>{


    private String userID;
    public CreateMethod(OAuthConstants.OAuthProto proto, String userID)
    {
        super(proto);
        this.userID = userID;
        addParameter(FatSecretCommons.METHOD, ProfileConstants.METHOD_PROFILE_CREATE);
